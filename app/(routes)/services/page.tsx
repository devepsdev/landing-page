...
const ServicesPage = () => {
  return (
    <>
      ...
      <CircleImage />
      <AvatarServices />
      <div className="relative z-10 grid items-center justify-center max-w-5xl gap-6 mx-auto md:grid-cols-2 md:h-screen pt-32 pb-32 md:pt-0 md:pb-0 px-4 md:px-0">
